...
OUTPUT_BASE="${OUTPUT_BASE:-/home/work_nfs23/hkxie/hw_proj/CosyVoice/testout/xmren/test_flowsft_0430}"
META_FILE="${META_FILE:-/home/work_nfs22/xmren/code/web/data/kefu_test/kefu_0423_onlymale_array_or_letters_tn_83.lst}"
