...
META_FILE="${META_FILE:-/home/work_nfs23/hkxie/huawei_streaming_cosyvoice/huawei_streaming_cosyvoice/kefu_test/kefu_0421_onlymale.lst}"
META_TAG="$(basename "${META_FILE}")"
META_TAG="${META_TAG%.*}"

MODEL_DIRS=(
  # "${CKPT_ROOT}/sft_shenhu_only_1e-5_from_llm"
  # "${CKPT_ROOT}/sft_xiaoyuzhou_shenhu_5-5_1e-5_spk"
