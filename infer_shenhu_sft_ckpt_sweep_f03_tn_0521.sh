...
OUTPUT_BASE="${OUTPUT_BASE:-/home/work_nfs23/hkxie/hw_proj/CosyVoice/testout/test_f03_0524}"
META_FILE="${META_FILE:-/home/work_nfs23/hkxie/huawei_streaming_cosyvoice/huawei_streaming_cosyvoice/kefu_test/kefu_0521_onlymale_f03.lst}" # /home/work_nfs23/hkxie/hw_proj/CosyVoice/data_list/kefu_0506_onlymale.lst
META_TAG="$(basename "${META_FILE}")"
META_TAG="${META_TAG%.*}"

MODEL_DIRS=(
  "${CKPT_ROOT}/sft_f03_base_only_1e-5_from_llm"
  "${CKPT_ROOT}/sft_f03_base_only_1e-6_from_llm"
  "${CKPT_ROOT}/sft_f03_only_1e-5"
  "${CKPT_ROOT}/sft_f03_only_1e-6"
)
