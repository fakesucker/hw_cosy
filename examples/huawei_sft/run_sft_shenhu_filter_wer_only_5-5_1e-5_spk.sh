...
# Shenhu subset: ASR WER & spkemb filtered jsonl (shenhu_filter_wer_only.lst).
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  for model in llm; do
    torchrun --nnodes=1 --nproc_per_node=$num_gpus \
        --rdzv_id=$job_id --rdzv_backend="c10d" --rdzv_endpoint="localhost:12755" \
      ../../cosyvoice/bin/train.py \
      --train_engine $train_engine \
      --config conf/cosyvoice2_sft_1e-5.yaml \
      --train_data /home/work_nfs23/hkxie/hw_proj/CosyVoice/data_list/splits/shenhu_filter_wer_only.lst \
      ...
      --model_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_shenhu_filter_wer_only_1e-5_from_llm \
      --tensorboard_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_shenhu_filter_wer_only_1e-5_from_llm/log \
