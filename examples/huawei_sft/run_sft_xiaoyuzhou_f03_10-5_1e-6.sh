...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  for model in llm; do
    torchrun --nnodes=1 --nproc_per_node=$num_gpus \
        --rdzv_id=$job_id --rdzv_backend="c10d" --rdzv_endpoint="localhost:12454" \
      ...
      --model_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_xiaoyuzhou_f03_10-5_1e-6 \
      --tensorboard_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_xiaoyuzhou_f03_10-5_1e-6/log \
