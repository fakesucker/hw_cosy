...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  # `pwd`/exp/cosyvoice2/$model/stack_streaming_with_campplus/$train_engine
  ...
  for model in llm; do
    torchrun --nnodes=1 --nproc_per_node=$num_gpus \
      ...
      --train_data /home/node62_data/hkxie/data/hw_data/train.data.list \
      --cv_data /home/node62_data/hkxie/data/hw_data/dev.data.list \
      ...
      --model_dir `pwd`/exp/cosyvoice2/sft_1e-6 \
      --tensorboard_dir `pwd`/tensorboard/cosyvoice2/sft_1e-6 \
