...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  for model in llm; do
    torchrun --nnodes=1 --nproc_per_node=$num_gpus \
        --rdzv_id=$job_id --rdzv_backend="c10d" --rdzv_endpoint="localhost:12457" \
      ../../cosyvoice/bin/train.py \
      --train_engine $train_engine \
      --config conf/cosyvoice2_sft_1e-5.yaml \
      --train_data /home/work_nfs23/hkxie/hw_proj/CosyVoice/data_list/splits/xiaoyuzhou_shenhu_10-5.lst \
      ...
      --model_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_xiaoyuzhou_shenhu_10-5_1e-5 \
      --tensorboard_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_xiaoyuzhou_shenhu_10-5_1e-5/log \
