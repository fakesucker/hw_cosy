...
BASE_SCRIPT="${SCRIPT_DIR}/run_sft_xiaoyuzhou_f03_5-5_1e-5.sh"
TMP_SCRIPT="$(mktemp /tmp/run_sft_top500k_f03_5-5_1e-5_spk.XXXXXX.sh)"
...
sed \
  ...
  -e 's#sft_xiaoyuzhou_f03_5-5_1e-5#sft_top500k_f03_5-5_1e-5_spk#g' \
