...
# F03-only SFT (SPK): 5-5 mix ratio, lr=1e-6, init from shenhu ckpt.
# Parallel layout (run_all_sft_4_parallel_f03_only_spk.sh): GPU 1, port 12452.
# . ./path.sh || exit 1;
...
MODEL_DIR=/home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_f03_only_1e-6
dist_backend="nccl"
num_workers=1
prefetch=200
# prefetch=0
