...
TMP_SCRIPT="$(mktemp /tmp/run_sft_top500k_shenhu_filter_wer_10-5_1e-6_spk.XXXXXX.sh)"
...
sed \
  ...
  -e 's#sft_xiaoyuzhou_shenhu_10-5_1e-6#sft_top500k_shenhu_filter_wer_10-5_1e-6_spk#g' \
