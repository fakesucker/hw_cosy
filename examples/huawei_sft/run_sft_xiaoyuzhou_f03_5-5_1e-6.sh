...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  for model in llm; do
    torchrun --nnodes=1 --nproc_per_node=$num_gpus \
        --rdzv_id=$job_id --rdzv_backend="c10d" --rdzv_endpoint="localhost:12452" \
      ../../cosyvoice/bin/train.py \
      --train_engine $train_engine \
      --config conf/cosyvoice2_sft_1e-6.yaml \
      --train_data /home/work_nfs23/hkxie/hw_proj/CosyVoice/data_list/splits/xiaoyuzhou_f03_5-5.lst \
      ...
      --model_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_xiaoyuzhou_f03_5-5_1e-6 \
      --tensorboard_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_xiaoyuzhou_f03_5-5_1e-6/log \
