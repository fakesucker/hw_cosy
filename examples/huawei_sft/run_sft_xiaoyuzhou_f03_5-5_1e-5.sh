...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
  ...
  for model in llm; do
    torchrun --nnodes=1 --nproc_per_node=$num_gpus \
      ...
      --model_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_xiaoyuzhou_f03_5-5_1e-5 \
      --tensorboard_dir /home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_xiaoyuzhou_f03_5-5_1e-5/log \
