...
echo "[sweep] META=${META_FILE} OUT=${RUN_OUTPUT_BASE} TOP_N=${TOP_N} CS_TN=${COSYVOICE_CUSTOMER_SERVICE_TN:-0} STREAM=${STREAM} BISTREAM_FIXED_RATIO=${BISTREAM_FIXED_RATIO}"
echo "============================================================"
