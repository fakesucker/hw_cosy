    ...
    def __init__(self, token_path, skip_special_tokens=True):
        ...
        special_tokens = {
            ...
            'additional_special_tokens': [
                ...
                "[lipsmack]", "[mn]", "<|spk_1|>", "<|spk_2|>", 
                "<|spk_3|>", "<|spk_4|>", "<|spk_5|>", "<|spk_6|>", 
                "<|spk_7|>", "<|spk_8|>", "<|spk_9|>", "<|spk_10|>"
            ]
        }
    ...
    def __init__(self, token_path, skip_special_tokens=True):
        ...
        special_tokens = {
            ...
            'additional_special_tokens': [
                ...
                "[ǎn]", "[ǎng]", "[ǎo]", "[ǐ]", "[ǐn]", "[ǐng]", "[ǒ]", "[ǒng]", "[ǒu]", "[ǔ]", "[ǔn]", "[ǘ]", "[ǚ]", "[ǜ]", "<|spk_1|>",
                "<|spk_2|>", "<|spk_3|>", "<|spk_4|>", "<|spk_5|>", "<|spk_6|>", "<|spk_7|>", "<|spk_8|>", "<|spk_9|>", "<|spk_10|>"
            ]
        }
        self.special_tokens = special_tokens
        self.tokenizer = AutoTokenizer.from_pretrained(token_path)
