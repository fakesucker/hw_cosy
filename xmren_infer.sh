...
MY_INFER_OUT="/home/work_nfs22/xmren/data/kefu/90w_tokens_noseed_F03prompt"
# summary_runs.tsv、skip 日志、未设 INFER_OUT_DIR 时的分层输出根目录（同样用你自己的路径）
MY_OUTPUT_BASE="/home/work_nfs22/xmren/data/kefu/infer_runs"

# 固定只推理该 .pt（对应目录须在 MODEL_DIRS / CKPT_ROOT 下存在 yaml 等）
MY_SINGLE_CKPT="${MY_SINGLE_CKPT:-/home/work_nfs23/hkxie/ckpt/huawei/cosyvoice2/sft_f03_only_1e-5/epoch_2_whole.pt}"
